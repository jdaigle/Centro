...
namespace OpenEntity.Query
{
    ...
    /// </summary>
    public class ColumnConstraint : IPredicate
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ColumnConstraint IsLike(string value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsNotLike(string value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsGreaterThan(object value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsGreaterThanOrEqualTo(object value)
        {
        ...
        ///// <returns></returns>
        //public Constraint In(Select selectQuery)
        //{
        ...
        /// <returns></returns>
        public ColumnConstraint IsIn(IEnumerable values)
        {
            InValues = values;
        ...
        ///// <param name="selectQuery">The select query.</param>
        ///// <returns></returns>
        //public Constraint NotIn(Select selectQuery)
        //{
        //    //validate that there is only one column in the columnlist
        //    if (selectQuery.SelectColumnList.Length == 0 || selectQuery.SelectColumnList.Length > 1)
        //        throw new InvalidOperationException("You must specify a column to return for the IN to be valid. Use Select(\"column\") to do this");
        ...
        /// <param name="values">Value array</param>
        /// <returns></returns>
        public ColumnConstraint IsNotIn(IEnumerable values)
        {
            InValues = values;
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsLessThan(object value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsLessThanOrEqualTo(object value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ColumnConstraint IsNotNull()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ColumnConstraint IsNull()
        {
        ...
        /// <returns></returns>
        public ColumnConstraint IsBetweenAnd(object value1, object value2)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsEqualTo(object value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public ColumnConstraint IsNotEqualTo(object value)
        {
